!function(n) {
    ...
    f.prototype = {
        ...
        _generateMarkup: function() {
            ...
            this.options.responsiveDropdown && n(i).resize(function() {
        ...
        _appendListItems: function(i, t) {
            ...
            n.each(i, function(n, i) {
                e += '<li class="country ' + t + '" data-country-code="' + i.iso2 + '">',
        ...
        _loadAutoCountry: function() {
            n.fn[a].autoCountry ? this.handleAutoCountry() : n.fn[a].startedLoadingAutoCountry || (n.fn[a].startedLoadingAutoCountry = !0,
        ...
        _bindDropdownListeners: function() {
            ...
            n(t).on("keydown" + this.ns, function(n) {
                n.preventDefault(),
                n.which == r || n.which == u ? i._handleUpDownKey(n.which) : n.which == l ? i._handleEnterKey() : n.which == h ? i._closeDropdown() : n.which >= p && n.which <= y || n.which === d ? (i.typedLetters += String.fromCharCode(n.which),
                i._filterCountries(i.typedLetters)) : n.which === c && (i.typedLetters = i.typedLetters.slice(0, -1),
        ...
        handleAutoCountry: function() {
            "auto" === this.options.initialCountry && (this.defaultCountry = n.fn[a].autoCountry,
    ...
    n.fn[a] = function(i) {
        ...
        return i === e || "object" == typeof i ? this.each(function() {
            ...
            e instanceof f && "function" == typeof e[i] && (t = e[i].apply(e, Array.prototype.slice.call(s, 1))),
